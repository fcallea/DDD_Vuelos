...
namespace Vuelos.Test.Application.UsesCases.Command.Vuelos.AsignarItinerario
{
    public class AsignarItinerarioCommand_Tests
    {
        ...
        public void AsignarItinerarioCommand_DataValid()
        {
            ...
            Assert.Equal(IdPista, command.Itinerario.IdPista);
            Assert.Equal(IdAeronave, command.Itinerario.IdAeronave);
        ...
        public void TestConstructor_IsPrivate()
        {
            ...
            Assert.NotNull((object)command.Itinerario.IdPista);
            Assert.NotNull((object)command.Itinerario.IdAeronave);
